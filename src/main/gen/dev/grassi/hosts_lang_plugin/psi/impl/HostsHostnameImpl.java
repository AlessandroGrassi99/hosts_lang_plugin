...
public class HostsHostnameImpl extends ASTWrapperPsiElement implements HostsHostname {

  public HostsHostnameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull HostsVisitor visitor) {
    visitor.visitHostname(this);
  }
